const rootPrefix = '../..',
  ...
  ExtractSlackParamsMiddleware = require(rootPrefix + '/middlewares/extractTriggerId'),
...
class InteractiveMiddlewareMethods {
  ...
  async InteractiveMiddleWareMethod(
    ...
    decodedParams.trigger_id = ExtractSlackParamsMiddleware.extractTriggerId(requestBody);
